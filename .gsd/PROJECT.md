...
- [ ] M002: Whimsy & Custom Borders — Mask/reverse-mask system for non-rectangular borders and whimsy piece placement with sub-puzzle splitting (S01 complete: shape library + boolean ops; S02 complete: boundary-aware grid generation with WASM endpoints; S03 complete: custom border UI with shape dropdown, piece count, URL persistence)
